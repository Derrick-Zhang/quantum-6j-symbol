...
\[Lambda]pls[n_,1]:=q^(4cassimir[n,{2}]);
\[Lambda]pls[n_,2]:=-q^(4cassimir[n,{2}]-cassimir[n,{1,1}]);
\[Lambda]pls[n_,3]:=q^(4cassimir[n,{2}]-cassimir[n,{2}]);
\[Lambda]pls[n_,4]:=q^(4cassimir[n,{2}]-cassimir[n,{2,2}]);
\[Lambda]pls[n_,5]:=-q^(4cassimir[n,{2}]-cassimir[n,{3,1}]);
\[Lambda]pls[n_,6]:=q^(4cassimir[n,{2}]-cassimir[n,{4}]);
\[Lambda]mns[n_,1]:=q^(cassimir[n,{}]);
\[Lambda]mns[n_,2]:=-q^(cassimir[n,{1,1}]);
\[Lambda]mns[n_,3]:=q^(cassimir[n,{2}]);
\[Lambda]mns[n_,4]:=q^(cassimir[n,{2,2}]);
\[Lambda]mns[n_,5]:=-q^(cassimir[n,{3,1}]);
\[Lambda]mns[n_,6]:=q^(cassimir[n,{4}]);
